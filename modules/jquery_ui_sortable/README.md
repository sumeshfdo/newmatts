...
jQuery UI Sortable library for any themes and modules that require it.

  - jQuery UI [Sortable documentation](https://jqueryui.com/sortable/)
  - jQuery UI [Sortable API documentation](https://api.jqueryui.com/sortable/)
...
2.  Change any references in your theme or module from
    `core/jquery.ui.sortable` to `jquery_ui_sortable/sortable`
